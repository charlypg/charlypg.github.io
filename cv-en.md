...
### Teaching Assistant at Sorbonne

* 2022 to 2026
* Sorbonne Université, Paris, France
* Tutorials, exercises, practical sessions
...
* Learning and Robotics (CS)
* AI for Robotics (Robotics)
* Advanced reinforcement learning applied to Cognitive Science (COGSUP MSc)

#### BSc

* Data structures in C (CS)
* Advanced C language (CS)
* Introduction to C language (CS)
* Raspberry Pi project (CS)
* Algorithms (CS)
* Agile Software Development (CS)
...
* Industrial computer science: micro-controllers, FPGAs

***

## Education

* 2022 to 2026: PhD to Sorbonne Université, Paris, France
* 2018 to 2022: ENS Paris-Saclay, Gif-sur-Yvette, France
    * MSc *ATSI* Research
        - Master ATSI, Université Paris-Saclay
        - Control and Signal processing
    * MSc *INTRANET*
        - Computer science and electrical engineering
* 2015 to 2018: Preparation MPSI/MP/MP&#x2217;, Lycée Saint-Louis, Paris, France
...
* 2022: **State-action representation learning for robotics**. ISIR, Sorbonne Université, Paris

* 2020: **Stigmergic models for swarm robotics**. TU Delft, Pays-Bas. *remote (COVID)*
