...
#### Master
* Modèles et Algorithmes Probabilistes et Statistiques (M1 info: MIND, AI2D)
...
* Structures de données en C (L2)
* Projet sur Raspberry Pi (L1)
* Projets de développement (L2)
* Informatique et statistiques (L2 bio)

### Mission doctorale d'enseignement en informatique

* 3 ans:  Sept. 2022 à Août 2025
* 64h équivalent TD
* Sorbonne Université, Paris, France

* **Enseignements :** C avancé (L2), Éléments de programmation en C (L1), Algorithmique (L2)

* **Conception du sujet d'examen** en C avancé (L2)

* **Conception d'évaluations formatives** en algorithmie (L2)

### Stage pédagogique en GEII
...
* 2018 à 2022: ENS Paris-Saclay, Gif-sur-Yvette, France
    * Master 2 Recherche (4A)
        - Master ATSI, Université Paris-Saclay
    * Master 2 INTRANET ; Préparation à l'agrégation (3A)
    * Master 1 E3A voie André Ampère (2A)
    * Formation SAPHIRE (1A)
* 2015 à 2018: CPGE MPSI/MP/MP&#x2217;, Lycée Saint-Louis, Paris, France
